...
$("#show-info").click(function(){
    ...
    if (userAge === "" || userColor === "") {
        $("#output").append('<div class="text warning"><p>Please enter both your age and favourite color!</p></div>');
        return;
    }
...
function glitchEffect(){
    // Array of random colors for backgraound and text
    ...
    $("#content").addClass("color", textColor);
